module m_helpers
    ...
    contains
        ...
        subroutine s_read_user_input()
            ...
            namelist /user_inputs/ gamma0, gamma1, N, L, Q0, Q1, U, tol
        ...
        ! This subroutine formatted prints an arbitrary 2D array.
        ! Its imputs are:
        !   A - an arbitrary m x n matrix
        !   div - an option faactor to divide numbers by
    ...
    subroutine s_compute_error(x1, x2, error)
        ...
        do i = 0, N
            diff(i) = abs(x1(i) - x2(i))
        end do

        error = maxval(diff)

    end subroutine s_compute_error
